...
def  write_to_file_bad_piece(board, piece):
    print("write bad_piece")
    print(save_board_to_file(board, "p_faulty_board.txt"))
    print(save_smth_to_file(piece, "p_faulty_piece.txt"))




def  write_to_file_bad_move(board, piece, move):
    print("write bad_move")
    print(save_board_to_file(board, "m_faulty_board.txt"))
    print(save_smth_to_file(piece, "m_faulty_piece.txt"))
    print(save_smth_to_file(move, "m_faulty_move.txt"))
...
def get_rezult_from_network(checkers):
    ...
    for iter in range(1, 33):
        ...
        for possible_move in possible_moves:
            if possible_move[0][0] == x1 and possible_move[0][1] == x2 and possible_move[1][0] == y1 and possible_move[1][1] == y2:
