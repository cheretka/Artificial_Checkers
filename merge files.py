...
def merge():
    ...
    filenames = ["board.1.17.txt", "board.2.100.txt", "board.4.100.txt", "board.5.100.txt", "board.6.100.txt", "board.7.200.txt", "board.8.500.txt", "board.9.100.txt", "board.10.250.txt", "board.11.250.txt"]

    # Open file3 in write mode
    with open('board.0.55869.txt', 'w') as outfile:
