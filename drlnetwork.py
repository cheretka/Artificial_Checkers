...
from Savery import *
from fit_all_models import *


def write_to_file(board_1, piece_1, move_1, board_2, piece_2):
    print("write to file")
    print(save_board_to_file(board_1, "correct_board_1.txt"))
    print(save_smth_to_file(piece_1, "correct_piece_1.txt"))
    print(save_smth_to_file(move_1, "correct_move_1.txt"))
    print(save_board_to_file(board_2, "correct_board_2.txt"))
    print(save_smth_to_file(piece_2, "correct_piece_2.txt"))
...
def play_game_and_write_moves():
    ...
    print("\n\n         PART 1    start   play_game_and_write_moves\n")
